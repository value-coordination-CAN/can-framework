...
- 🗺️ [Value Map API](implementation/value-map-api.md): needs and capacities on a node, shareable verifiable slices, and opt-in commitment discovery that answers match or no match.
