...
- 📘 [WP-005: Six-Degree Network Ledger Architecture and Hybrid Non-Monetary Complex Settlement](publications/wp-005-six-degree-network-ledger/)
- 📘 [WP-006: Operationalising Graph Settlement — Simulation, Governance Stress Testing, and Deployment Framework](publications/wp-006-operationalising-graph-settlement/)
