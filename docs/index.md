...
- 🗺️ [Value Map API](implementation/value-map-api.md): needs and capacities on a node, shareable verifiable slices, opt-in commitment discovery, and peered nodes forwarding a query a few hops to return a path and its confidence.
