...
Evidence goes stale unless something keeps it current. Value assurance uses agents, human and artificial (see [AI and Agent Participation](../about/ai-and-agents-participation.md)), in a continuous loop:

1. **Detect:** a change in inputs, such as demand, prices, regulation, condition or contribution.
2. **Interpret:** what it means for this asset's assumptions.
3. **Recalculate:** scenario values and entitlements.
4. **Explain:** in terms the holder and affected parties can read and contest.
5. **Act:** within mandates set by the holder or by law, for example re-pricing access, pledging, re-allocating or alerting.
...
1. it can **prove** what its assets are worth under changing assumptions; and
2. the **people** its assets depend on have reasons to be there.
